---
name: monitor
description: Track campaign performance and optimize — Lemlist stats, alerts, recommendations. Use to check how campaigns are performing.
---

# Monitor — Outbound Engine by BuildYourSales.tech
